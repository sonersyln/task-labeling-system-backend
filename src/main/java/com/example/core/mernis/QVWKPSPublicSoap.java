...
public class QVWKPSPublicSoap
{
    ...
    public QVWKPSPublicSoap(){}

    public QVWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QVWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QVWExtendedSoapSerializationEnvelope envelope= new QVWExtendedSoapSerializationEnvelope(QVWExtendedSoapSerializationEnvelope.VER11);
