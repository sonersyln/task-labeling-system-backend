...
public class EUUKPSPublicSoap12
{
    ...
    public EUUKPSPublicSoap12(){}

    public EUUKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public EUUKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EUUExtendedSoapSerializationEnvelope envelope= new EUUExtendedSoapSerializationEnvelope(EUUExtendedSoapSerializationEnvelope.VER12);
